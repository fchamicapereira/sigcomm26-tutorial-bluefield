#!/usr/bin/env bash
#
# Build the tutorial container image (DOCA 2.9.1 devel base — see the Dockerfile) and drop into
# an interactive shell inside it, with the DPU hardware exposed so the FULL tutorial — including
